...
const ManagePosts = () => {
  ...
  useEffect(() => {
    if (user?.email && token) {
      fetch(`https://voluntree-server-ipvpml078-ulfatharaislams-projects.vercel.app/my-volunteers?email=${user.email}`, {
        headers: {
      ...
      fetch(`https://voluntree-server-ipvpml078-ulfatharaislams-projects.vercel.app/my-volunteer-requests?email=${user.email}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleDeletePost = async (id) => {
    ...
    const res = await fetch(`https://voluntree-server-ipvpml078-ulfatharaislams-projects.vercel.app/volunteers/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  const handleCancelRequest = async (id) => {
    ...
    const res = await fetch(`https://voluntree-server-ipvpml078-ulfatharaislams-projects.vercel.app/volunteerRequests/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
